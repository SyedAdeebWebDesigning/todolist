			...
			<div>
				<header className="text-gray-600 body-font shadow-lg">
					<div className="container mx-auto flex flex-wrap justify-between p-5 flex-col md:flex-row items-center">
						...
						<button className="inline-flex items-center md:text-xl justify-center border-0 md:py-2 px-4 focus:outline-none rounded-xl md:mt-0">
							<a href="/account" className="flex space-x-2 items-center">
								View Account
								<svg
									fill="none"
									stroke="currentColor"
